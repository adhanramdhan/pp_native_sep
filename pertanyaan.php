<?php
    ...
    if (isset($_POST['register'])){
        ...
        $queryInsert = mysqli_query($koneksi, "INSERT INTO pendaftaran (id_jurusan, nik, name, email, phone, gender, alamat, pendidikan, gelombang, tahun_pelatihan) VALUES ('$id_jurusan','$nik', '$name', '$email', '$phone', '$gender', '$alamat', '$pendidikan', '$gelombang', '$tahun_pelatihan' ) ");
        if($queryInsert){
